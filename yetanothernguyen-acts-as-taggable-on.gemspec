...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-06-15}
  s.description = %q{With ActsAsTaggableOn, you could tag a single model on several contexts, such as skills, interests, and awards. It also provides other advanced functionality. This fork changes the behavior of tagged_with. It will return empty scope on empty or nil tag list.}
